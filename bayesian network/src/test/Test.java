...
*/
		...
		//ノードリスト出力
		NodeListPrintWriter nlp = new NodeListPrintWriter("community_node100000.csv");
		nlp.print(nodelist);

		//CPT出力
		CPTPrintWriter cptp = new CPTPrintWriter("community_CPT100000.csv");
		cptp.print(cptlist);
