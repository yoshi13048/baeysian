...
public class CommunityTest {
	...
	public static void main(String[] args){
		...
		int total_node_num = 100;

		//csvから読み込み
		NodeListReader nlr = new NodeListReader("community_node100.csv");
		ArrayList<Nodes> nodelist = nlr.read();

		//csvから読み込み
		CPTReader cptr = new CPTReader("community_CPT100.csv");
		...
		*/
		...
		Integer community_to_num1 = 5;
		Integer community_from_num2 = 6;
		Integer community_to_num2 = 5;
		Integer community_total_num = 7;

		//計算
		AnnealingOptimize ao = new AnnealingOptimize(T, cool, community_from_num1, community_to_num1, first_half_list, first_list, communitylist1);
		ao.action();
		...
		*/
		...
		//表示
		CommunityAllDisplay calld = new CommunityAllDisplay(communitylist);
